	...
	<div class="well">
		...
		@foreach($users as $user)
			...
			<li class="clearfix {{ $class }}">
				...
				@else
					@if($user['active'])
						<div class="span-left span-10 aligncenter"><div class="span-pad"><span class="btn green small active_state" data-id="{{ $user['id'] }}" data-state="active">yes</span></div></div>
					@else
						<div class="span-left span-10 aligncenter"><div class="span-pad"><span class="btn orange small active_state" data-id="{{ $user['id'] }}" data-state="inactive">no</span></div></div>
					@endif
				@endif
